#!/usr/bin/env python3
"""Send decoded master Piper command targets over UDP without gripper targets.
...
This variant intentionally omits gripper targets from outgoing packets, for
setups where the slave gripper is not connected.
"""
...
def main() -> None:
    """Run the master CAN-to-UDP bridge without gripper targets."""
